...
func receivedShareScope(ctx context.Context, scope *authpb.Scope, resource interface{}, logger *zerolog.Logger) (bool, error) {
	_, span := tracing.SpanStartFromContext(ctx, tracerName, "receivedShareScope")
	defer span.End()
